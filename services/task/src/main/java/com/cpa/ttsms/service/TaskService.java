...
//	List<Task> getAllParentTasksByStatus(String status);
	 ...
	 * @return A list of ParentAndChildTaskDTO objects created and assigned by the specified employee.
	 ...
	 */
	List<ParentAndChildTaskDTO>getAllTaskCreatedByMeAndAssignToMe(int employeeId);
}