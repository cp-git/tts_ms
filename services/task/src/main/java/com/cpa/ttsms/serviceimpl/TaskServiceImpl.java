...
public class TaskServiceImpl implements TaskService {
	...
	// "https://localhost:8443/reason/ttsms/reason";
	// private final String UPLOAD_FILE_URL =
	// "https://localhost:8443/uploadfile/ttsms/upload";
	// private final String email_URL = "https://localhost:8443/email/taskMail";
	// private final String employee_URL =
	// "https://localhost:8443/employee/ttsms/employee/";
	// private final String status_URL =
	// "https://localhost:8443/status/ttsms/status/";
	// private final String task_URL = "https://localhost:8443/task/ttsms/task/";
